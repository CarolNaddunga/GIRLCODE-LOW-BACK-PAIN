  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <Card className="lg:col-span-2 p-7 relative overflow-hidden">
          ...
          <div className="flex items-center justify-center py-2 relative">
            <ImagePlaceholder label="Add latest scan photo" className="w-[220px] aspect-[3/4] animate-drift" />

            <div className="absolute left-0 top-4 rounded-2xl border border-line bg-paper px-3.5 py-2.5 hidden sm:block">
              <p className="text-[11px] text-ink-soft">Trunk angle</p>
              <p className="font-semibold text-sm">{vitals.trunkAngle.value}° lean</p>
            </div>
            <div className="absolute right-0 top-2 rounded-2xl border border-line bg-paper px-3.5 py-2.5 hidden sm:block">
              <p className="text-[11px] text-ink-soft">Hip alignment</p>
              <p className="font-semibold text-sm">{vitals.hipAlignment.value}%</p>
            </div>
            <div className="absolute left-2 bottom-2 rounded-2xl border border-line bg-paper px-3.5 py-2.5 hidden sm:block">
        ...
        <Card className="lg:col-span-2 p-7">
          ...
          <ResponsiveContainer width="100%" height={160}>
            <LineChart data={painTrend} margin={{ top: 6, right: 6, left: -18, bottom: 0 }}>
              ...
              <Tooltip contentStyle={{ borderRadius: 12, border: '1px solid #e9e6f4', boxShadow: '0 8px 24px rgba(76,63,130,0.10)' }} />
